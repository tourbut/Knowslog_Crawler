...
# PDF 파일 읽기
df_2022 = tabula.read_pdf("tester/토스증권_20220101_20221231_1.pdf", pages='all')
df_2023 = tabula.read_pdf("tester/토스증권_20230101_20231231_1.pdf", pages='all')
df_2024 = tabula.read_pdf("tester/토스증권_20240101_20241231_1.pdf", pages='all')
